...
//| Class                                                            |
//+------------------------------------------------------------------+
class BlackCloud : public CandleStick 
  {
    private:
    ...
    public:
      BlackCloud(const int value,const string inpattern);
      ~BlackCloud();
...
//+------------------------------------------------------------------+
BlackCloud::BlackCloud(const int value,const string inpattern)
  {
...
//| Write black cloud                                                |
//+------------------------------------------------------------------+
void BlackCloud::Write(const int value)
  {
...
//| Verify black cloud                                               |
//+------------------------------------------------------------------+
bool BlackCloud::Main(const int value,const string intimenow,const bool save,const double average)
  {
//---
    int value1=value;
    int value2=value+1;
...
//---
      if((account[4]==TRUE) && (account[4]==TRUE) && (account[3]==TRUE) && (account[2]==TRUE) && (account[1]==TRUE)) {
//---
...
//--- 
        if((longred(inOpen1,inClose1,mean)) && (inOpen1>inHigh2)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2042));
          thrut[1]=TRUE;
        };
//---
        if((longred(inOpen1,inClose1,mean)) && (belowhalfgreen(inHigh2,inLow2,inClose1))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2122));
          thrut[2]=TRUE;        
        };
//---        
