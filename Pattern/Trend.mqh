...
class Trend : CandleStick
  {
    ...
    public:
      ...
      bool Low(const int quantity,const int start,const string intimenow,const bool save);
  };
//+------------------------------------------------------------------+
//| Constructor                                                      |
//+------------------------------------------------------------------+
...
//| Write                                                            |
//+------------------------------------------------------------------+
void Trend::Write(const int value)
  {
...
//| Trend low                                                        |
///+-----------------------------------------------------------------+
bool Trend::Low(const int quantity,const int start,const string intimenow,const bool save)
  {
//---    
    const int inquantity=quantity;
//---
