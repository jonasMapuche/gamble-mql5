...
//| Class                                                            |
//+------------------------------------------------------------------+
class SplitLine : public CandleStick
  {
    private:
    ...
    public:
      SplitLine(const int value,const string inpattern);
      ~SplitLine();
...
//+------------------------------------------------------------------+
SplitLine::SplitLine(const int value,const string inpattern)
  {
...
//| Write split line                                                 |
//+------------------------------------------------------------------+
void SplitLine::Write(const int value)
  {
...
//+------------------------------------------------------------------+
//| Verify split line high                                           |
//+------------------------------------------------------------------+
bool SplitLine::High(const int value,const string intimenow,const bool save,const double average)
  {
//---
...
//---
        if(marubozured(inHigh2,inOpen2,inClose2,inLow2,percent3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2002));
          thrut[1]=TRUE;
        };
//---
        if((longgreen(inOpen1,inClose1,mean)) && (equalopengreenred(inOpen2,inClose2,inOpen1,inClose1,percent3))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2032));
          thrut[2]=TRUE;
        };
//---
        if((marubozugreen(inHigh1,inOpen1,inClose1,inLow1,percent3)) && equalopengreenred(inOpen2,inClose2,inOpen1,inClose1,percent3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2032));
          thrut[3]=TRUE;
        };
//---
...
//+------------------------------------------------------------------+
//| Verify split line low                                            |
//+------------------------------------------------------------------+
bool SplitLine::Low(const int value,const string intimenow,const bool save,const double average)
  {
//---
    double percent3=0.0003;
    int value1=value;
...
//---
        if(marubozugreen(inHigh2,inOpen2,inClose2,inLow2,percent3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2001));
          thrut[1]=TRUE;
        };
//---
        if((longred(inOpen1,inClose1,mean)) && (equalopenredgreen(inOpen2,inClose2,inOpen1,inClose1,percent3))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2032));
          thrut[2]=TRUE;
        };
//---
        if((marubozured(inHigh1,inOpen1,inClose1,inLow1,percent3)) && equalopenredgreen(inOpen2,inClose2,inOpen1,inClose1,percent3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2032));
          thrut[3]=TRUE;
        };
//---
