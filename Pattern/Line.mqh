...
class Line : public CandleStick
  {
    ...
    public:
      Line(const int value,const string inpattern);
      ~Line();
...
//+------------------------------------------------------------------+
Line::Line(const int value,const string inpattern)
  {
...
//+------------------------------------------------------------------+
//| Write line high and low                                          |
//+------------------------------------------------------------------+
void Line::Write(const int value)
  {
...
//| Verify line high                                                 |
//+------------------------------------------------------------------+
bool Line::High(const int value,const string intimenow,const bool save,const double average)
  {
//---
...
//---
        if((longgreen(inOpen1,inClose1,mean)) && (linegreen(inOpen2,inClose2,inOpen1,inClose1,percent3))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2132));
          thrut[1]=TRUE;
        };
//---
        if((longgreen(inOpen2,inClose2,mean)) && (linegreen(inOpen2,inClose2,inOpen1,inClose1,percent3))){
...
//| Verify line low                                                  |
//+------------------------------------------------------------------+
bool Line::Low(const int value,const string intimenow,const bool save,const double average)
  {
//---
    double percent3=0.0003;
    int value1=value;
...
//---
        if((longred(inOpen1,inClose1,mean)) && (linered(inOpen2,inClose2,inOpen1,inClose1,percent3))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2132));
          thrut[1]=TRUE;
        };
//---
        if((longred(inOpen2,inClose2,mean)) && (linered(inOpen2,inClose2,inOpen1,inClose1,percent3))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2131));
          thrut[2]=TRUE;
        };
//---
