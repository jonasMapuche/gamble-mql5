...
//| Class                                                            |
//+------------------------------------------------------------------+
class Strike : public CandleStick
  {
    private:
    ...
    public:
      Strike(const int value,const string inpattern);
      ~Strike();
...
//+------------------------------------------------------------------+
Strike::Strike(const int value,const string inpattern)
  {
...
//| Write strike green                                               |
//+------------------------------------------------------------------+
void Strike::Write(const int value)
  {
...
//| Verify strike high                                               |
//+------------------------------------------------------------------+
bool Strike::High(const int value,const string intimenow,const bool save,const double average)
  {
//---
    int value1=value;
    int value2=value+1;
...
//---
        if(green(inOpen4,inClose4)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2002));
          thrut[0]=TRUE;
        };
//---
        if(inClose3>inClose4){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2094));
          thrut[1]=TRUE;
        };
//---
        if(inOpen3>inOpen4){
...
//---
        if(inOpen1>inClose2){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2312));
          thrut[5]=TRUE;
        };
//---
        if(inClose1<inOpen4){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2114));
          thrut[6]=TRUE;
        };
//---
...
//| Verify strike low                                                |
//+------------------------------------------------------------------+
bool Strike::Low(const int value,const string intimenow,const bool save,const double average)
  {
//---
    int value1=value;
    int value2=value+1;
...
//---
        ...
        for(int i=0; i<max; i++) thrut[i]=FALSE;
//---
        if(red(inOpen4,inClose4)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2001));
          thrut[0]=TRUE;
        };
//---
        if(inClose3<inClose4){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2104));
          thrut[1]=TRUE;
        };
//---
        if(inOpen3<inOpen4){
...
//---
        if(inOpen1<inClose2){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2152));
          thrut[5]=TRUE;
        };
//---
        if(inClose1>inOpen4){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2084));
          thrut[6]=TRUE;
        };
//---
        if((thrut[0]==TRUE) && (thrut[1]==TRUE) && (thrut[2]==TRUE) && (thrut[3]==TRUE) && (thrut[4]==TRUE) && (thrut[5]==TRUE) && (thrut[6]==TRUE)){
