...
//| Class                                                            |
//+------------------------------------------------------------------+
class DescendingFalcon : public CandleStick
  {
    private:
    ...
    public:
      DescendingFalcon(const int value,const string inpattern);
      ~DescendingFalcon();
...
//+------------------------------------------------------------------+
DescendingFalcon::DescendingFalcon(const int value,const string inpattern)
  {
...
//+------------------------------------------------------------------+
//| Write low descending falcon                                      |
//+------------------------------------------------------------------+
void DescendingFalcon::Write(const int value)
  {
...
//+------------------------------------------------------------------+
//| Verify descending falcon low                                     |
//+------------------------------------------------------------------+
bool DescendingFalcon::Main(const int value,const string intimenow,const bool save,const double average)
  {
//---
    int value1=value;
    int value2=value+1;
