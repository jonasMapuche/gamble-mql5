...
//| Class                                                            |
//+------------------------------------------------------------------+
class StickSandwich : public CandleStick
  {
    private:
    ...
    public:
      StickSandwich(const int value,const string inpattern);
      ~StickSandwich();
...
//+------------------------------------------------------------------+
StickSandwich::StickSandwich(const int value,const string inpattern)
  {
...
//+------------------------------------------------------------------+
//| Write stick sandwich high                                        |
//+------------------------------------------------------------------+
void StickSandwich::Write(const int value)
  {
...
//+------------------------------------------------------------------+
//| Verify stick sandwich high                                       |
//+------------------------------------------------------------------+
bool StickSandwich::Main(const int value,const string intimenow,const bool save,const double average)
  {
//---
...
//---
        if(inClose2>inHigh3){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2073));
          thrut[2]=TRUE;
        };
//---
        if(inLow2>=inClose3){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2283));
          thrut[3]=TRUE;
        };
//---
...
//---
        if((marubozured(inHigh1,inOpen1,inClose1,inLow1,percent9)) && (linered(inOpen3,inClose3,inOpen1,inClose1,percent3))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2133));
          thrut[5]=TRUE;
        };
//---
