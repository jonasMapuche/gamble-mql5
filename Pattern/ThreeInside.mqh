...
//| Class                                                            |
//+------------------------------------------------------------------+
class ThreeInside : public CandleStick
  {
    private:
    ...
    public:
      ThreeInside(const int value,const string inpattern);
      ~ThreeInside();
...
//+------------------------------------------------------------------+
ThreeInside::ThreeInside(const int value,const string inpattern)
  {
...
//+------------------------------------------------------------------+
//| Write three inside high and low                                  |
//+------------------------------------------------------------------+
void ThreeInside::Write(const int value)
  {
...
//+------------------------------------------------------------------+
//| Verify three inside high                                         |
//+------------------------------------------------------------------+
bool ThreeInside::High(const int value,const string intimenow,const bool save,const double average)
  {
//---
    int value1=value;
    int value2=value+1;
...
//---
        if(insidebodyred(inOpen3,inClose3,inHigh2,inLow2)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2203));                  
          thrut[1]=TRUE;
        };
//---
        if((longgreen(inOpen1,inClose1,mean)) && (inClose1>inHigh2)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2072));                  
          thrut[2]=TRUE;
        };
//---
        if((longgreen(inOpen1,inClose1,mean)) && (inClose1>inHigh3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2073));                  
          thrut[3]=TRUE;
        };
//---
...
//+------------------------------------------------------------------+
//| Verify three inside low                                          |
//+------------------------------------------------------------------+
bool ThreeInside::Low(const int value,const string intimenow,const bool save,const double average)
  {
//---
    int value1=value;
    int value2=value+1;
...
//---
        if(insidebodygreen(inOpen3,inClose3,inHigh2,inLow2)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2203));                  
          thrut[1]=TRUE;
        };
//---
        if((longred(inOpen1,inClose1,mean)) && (inClose1<inLow2)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2302));                  
          thrut[2]=TRUE;
        };
//---
        if((longred(inOpen1,inClose1,mean)) && (inClose1<inLow3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2303));                  
          thrut[3]=TRUE;
        };
//---
        if ((thrut[0]==TRUE) && (thrut[1]==TRUE) && (thrut[2]==TRUE) && (thrut[3]==TRUE)) {
