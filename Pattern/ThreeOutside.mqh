...
//| Class                                                            |
//+------------------------------------------------------------------+
class ThreeOutside : public CandleStick
  {
    private:
    ...
    public:
      ThreeOutside(const int value,const string inpattern);
      ~ThreeOutside();
...
//+------------------------------------------------------------------+
ThreeOutside::ThreeOutside(const int value,const string inpattern)
  {
...
//| Write three outside                                              |
//+------------------------------------------------------------------+
void ThreeOutside::Write(const int value)
  {
...
//+------------------------------------------------------------------+
//| Verify three outside                                             |
//+------------------------------------------------------------------+
bool ThreeOutside::Main(const int value,const string intimenow,const bool save,const double average)
  {
//---
...
//---
    double inOpen1=0;
    double inOpen2=0,inClose2=0,inClose2Down3=0;
...
//---
        ...
        inClose2Down3=inClose2-(inClose2*percent3);
//---
...
//---
        if(engulfmentgreen(inHigh3,inLow3,inOpen2,inClose2)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2213));
          thrut[1]=TRUE;
        };
//---
        if(inOpen1>=inClose2Down3){
