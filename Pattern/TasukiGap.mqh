...
//| Class                                                            |
//+------------------------------------------------------------------+
class TasukiGap : public CandleStick
  {
    private:
    ...
    public:
      TasukiGap(const int value,const string inpattern);
      ~TasukiGap();
...
//+------------------------------------------------------------------+
TasukiGap::TasukiGap(const int value,const string inpattern)
  {
...
//| Write tasikig gap                                                |
//+------------------------------------------------------------------+
void TasukiGap::Write(const int value)
  {
...
//+------------------------------------------------------------------+
//| Verify tasuki gap high                                           |
//+------------------------------------------------------------------+
bool TasukiGap::High(const int value,const string intimenow,const bool save,const double average)
  {
//---
...
//---
        if(marubozugreen(inHigh3,inOpen3,inClose3,inLow3,percent3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2002));
          thrut[1]=TRUE;
        };
//---
        if((longgreen(inOpen2,inClose2,mean)) && (inLow2>inClose3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2283));
          thrut[2]=TRUE;
        };
//---
        if((marubozugreen(inHigh2,inOpen2,inClose2,inLow2,percent3)) && (inLow2>inClose3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2283));
          thrut[3]=TRUE;
        };
//---
        if(inClose1<inOpen2){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2112));
          thrut[4]=TRUE;
        };
//---
...
//---
        if((thrut[0]==TRUE) && (thrut[1]==TRUE) && (thrut[2]==TRUE) && (thrut[3]==TRUE) && (thrut[4]==TRUE) && (thrut[5]==TRUE)){
...
//+------------------------------------------------------------------+
//| Verify tasuki gap low                                            |
//+------------------------------------------------------------------+
bool TasukiGap::Low(const int value,const string intimenow,const bool save,const double average)
  {
//---
    double percent3=0.0003;
    int value1=value;
...
//---
        if(marubozured(inHigh3,inOpen3,inClose3,inLow3,percent3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2001));
          thrut[1]=TRUE;
        };
//---
        if((longred(inOpen2,inClose2,mean)) && (inHigh2<inClose3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2293));
          thrut[2]=TRUE;
        };
//---
        if((marubozured(inHigh2,inOpen2,inClose2,inLow2,percent3)) && (inHigh2<inClose3)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2293));
          thrut[3]=TRUE;
        };
//---
        if(inClose1>inOpen2){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2082));
          thrut[4]=TRUE;
        };
//---
        if(inClose1<inClose3){
