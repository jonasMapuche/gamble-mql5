...
//| Class                                                            |
//+------------------------------------------------------------------+
class BabySwallowed : public CandleStick
  {
    private:
    ...
    public:
      BabySwallowed(const int value,const string inpattern);
      ~BabySwallowed();
...
//+------------------------------------------------------------------+
BabySwallowed::BabySwallowed(const int value,const string inpattern)
  {
...
//+------------------------------------------------------------------+
//| Write baby swallowed                                             |
//+------------------------------------------------------------------+
void BabySwallowed::Write(const int value)
  {
...
//+------------------------------------------------------------------+
//| Verify baby swallowed high                                       |
//+------------------------------------------------------------------+
bool BabySwallowed::High(const int value,const string intimenow,const bool save,const double average)
  {
//---
...
//---
        if(marubozured(inHigh4,inOpen4,inClose4,inLow4,percent9)){
...
//---
        if(marubozured(inHigh3,inOpen3,inClose3,inLow3,percent9)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2000));
          thrut[1]=TRUE;
        };
//---
...
//---
        if((marubozured(inHigh1,inOpen1,inClose1,inLow1,percent9)) && (engulfmentred(inHigh2,inLow2,inOpen1,inClose1))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2212));
          thrut[3]=TRUE;
        };
//---
...
//+------------------------------------------------------------------+
//| Verify baby swallowed low                                        |
//+------------------------------------------------------------------+
bool BabySwallowed::Low(const int value,const string intimenow,const bool save,const double average)
  {
//---
    double percent3=0.0003;
    double percent9=0.0009;
...
//---
        ...
        for(int i=0; i<max; i++) thrut[i]=FALSE;
//---
        if(marubozugreen(inHigh4,inOpen4,inClose4,inLow4,percent9)){
...
//---
        if((hammergreen(inHigh2,inOpen2,inClose2,inLow2,mean,percent3)) || (hammerred(inHigh2,inOpen2,inClose2,inLow2,mean,percent3))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1004),GetRuleCandle(2000));
          thrut[2]=TRUE;
        };
//---
        if((marubozugreen(inHigh1,inOpen1,inClose1,inLow1,percent9)) && (engulfmentgreen(inHigh2,inLow2,inOpen1,inClose1))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1006),GetRuleCandle(2212));
          thrut[3]=TRUE;
        };
//---
