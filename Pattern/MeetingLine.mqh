...
//| Class                                                            |
//+------------------------------------------------------------------+
class MeetingLine : public CandleStick
  {
    private:
    ...
    public:
      MeetingLine(const int value,const string inpattern);
      ~MeetingLine();
...
//+------------------------------------------------------------------+
MeetingLine::MeetingLine(const int value,const string inpattern)
  {
...
//+------------------------------------------------------------------+
//| Write meeting line high and low                                  |
//+------------------------------------------------------------------+
void MeetingLine::Write(const int value)
  {
...
//+------------------------------------------------------------------+
//| Verify metting line high                                         |
//+------------------------------------------------------------------+
bool MeetingLine::High(const int value,const string intimenow,const bool save,const double average)
  {
//---
...
//---
        if((longgreen(inOpen1,inClose1,mean)) && (meetingline(inClose2,inClose1,percent3))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2132));
          thrut[1]=TRUE;
        };
//---
        if((longred(inOpen2,inClose2,mean)) && (meetingline(inClose2,inClose1,percent3))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2131));
          thrut[2]=TRUE;
        };
//---
...
//+------------------------------------------------------------------+
//| Verify metting line low                                          |
//+------------------------------------------------------------------+
bool MeetingLine::Low(const int value,const string intimenow,const bool save,const double average)
  {
//---
    double percent3=0.0003;
    int value1=value;
...
//---
        if((longred(inOpen1,inClose1,mean)) && (meetingline(inClose2,inClose1,percent3))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2132));
          thrut[1]=TRUE;
        };
//---
        if((longgreen(inOpen2,inClose2,mean)) && (meetingline(inClose2,inClose1,percent3))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1003),GetRuleCandle(2131));
          thrut[2]=TRUE;
        };
//---
