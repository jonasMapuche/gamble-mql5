...
//| Class                                                            |
//+------------------------------------------------------------------+
class EveningStar : public CandleStick
  {
    private:
    ...
    public:
      EveningStar(const int value,const string inpattern);
      ~EveningStar();
...
//+------------------------------------------------------------------+
EveningStar::EveningStar(const int value,const string inpattern)
  {
...
//| Write morning star                                               |
//+------------------------------------------------------------------+
void EveningStar::Write(const int value)
  {
...
//| Verify morning star                                              |
//+------------------------------------------------------------------+
bool EveningStar::Main(const int value,const string intimenow,const bool save,const double average)
  {
 //---
    int value1=value;
    int value2=value+1;
...
//---          
        if((eveningstargreen(inClose3,inOpen2,inClose2,inOpen1)) || (eveningstarred(inClose3,inOpen2,inClose2,inOpen1))){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2243));
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2251));
          thrut[1]=TRUE;
        };
//---
        if(belowhalfbodygreen(inOpen3,inClose3,inClose1)){
          if(save) sqlite.SaveRule(intimenow,inPattern,inSymbol,inTime,GetTypeCandle(1001),GetRuleCandle(2123));
          thrut[2]=TRUE;
        };
//---
